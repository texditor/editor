export const RuLocale = {
  ...
  columnAddLeft: 'Добавить слева',
  columnAddRight: 'Добавить справа',
  columnRemove: 'Удалить столбец',
  cellAlign: 'Горизонтальное выравнивание',
  cellAlignLeft: 'По левому краю',
  cellAlignCenter: 'По центру',
  cellAlignRight: 'По правому краю',
  cellVerticalAlign: 'Вертикальное выравнивание',
  cellValignTop: 'Сверху',
  cellValignMiddle: 'По центру',
  cellValignBottom: 'Снизу',
  cellAlignApplyToColumn: 'Применить ко всей колонке',
  cellAlignApplyToRow: 'Применить ко всему ряду',
  tableMaxRows: 'Достигнуто максимальное количество рядов',
